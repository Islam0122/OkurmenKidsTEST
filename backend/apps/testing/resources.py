"""
Import-Export resources for the Testing app.

Requires:  pip install django-import-export
Add to INSTALLED_APPS:  'import_export',
"""
...
class TestResource(resources.ModelResource):
    ...
    def dehydrate_question_count(self, obj):
...
class QuestionOptionResource(resources.ModelResource):
    ...
    def dehydrate_question_text(self, obj):
        return obj.question.text[:120] if obj.question_id else ''

    def dehydrate_test_title(self, obj):
...
class TestSessionResource(resources.ModelResource):
    ...
    class Meta:
        ...
        skip_unchanged   = True
        report_skipped   = True
        # Sessions should never be created via import — too risky.
        # Allow export only; guard import in admin via can_import = False.

    def dehydrate_attempt_count(self, obj):
        return obj.attempts.count()

    def dehydrate_active_attempt_count(self, obj):
...
class AnswerResource(resources.ModelResource):
    ...
    def dehydrate_question_type(self, obj):
