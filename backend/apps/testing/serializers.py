...
class QuestionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Question
        fields = ['id', 'text', 'question_type', 'language', 'difficulty', 'order', 'options']


class QuestionWriteSerializer(serializers.ModelSerializer):
    class Meta:
        model  = Question
        fields = ['id', 'test', 'text', 'question_type', 'language', 'difficulty', 'order']
...
class TestListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = Test
        fields = ['id', 'title', 'description', 'level', 'is_active', 'question_count', 'created_at']
...
class SessionEnterSerializer(serializers.Serializer):
...
class TestSessionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model  = TestSession
        fields = ['id', 'key', 'test_title', 'is_active', 'is_valid',
...
class StudentAttemptSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'test_title', 'session_key', 'student_name',
